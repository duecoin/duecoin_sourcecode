...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("DUEC");
    case mBTC: return QString("mDUEC");
    case uBTC: return QString::fromUtf8("μDUEC");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("DueCoins"));
    case mBTC: return QString(QObject::tr("Milli-DueCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-DueCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
